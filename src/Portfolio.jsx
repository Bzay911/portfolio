...
import { Github, Twitter, aedin, Mail, ChevronDown, Smartphone, Layers, Send, Code, Zap, Cpu, ArrowRight } from 'lucide-react'
...
const projects = [
  { 
    id: 'fittrack-pro',
    title: "FitTrack Pro",
    description: "Fitness tracking with AI-powered insights",
  ...
  { 
    id: 'ecoscan',
    title: "EcoScan",
    description: "Scan products for eco-friendliness ratings",
        ...
        <section id="home" className="min-h-screen flex flex-col md:flex-row justify-center items-center relative overflow-hidden">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-gray-300">
              Crafting intuitive and powerful mobile experiences that push the boundaries of what's possible.
            </p>
            <p className="text-xl md:text-2xl mb-8">
              Specializing in <TypeWriter words={['React Native', 'iOS Development', 'Android Development', 'UI/UX Design']} />
            </p>
            <motion.div
        ...
        <section id="skills" className="py-24 relative">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              {['React Native', 'iOS Development', 'Android Development', 'UI/UX Design', 'API Integration', 'Performance Optimization'].map((skill, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 50 }}
                  animate={{ opacity: 1, y: 0 }}
      ...
      <footer className="bg-gray-900 py-16">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
            <p className="text-gray-400 text-lg">&copy; 2024 AppMaestro. Transforming ideas into digital realities.</p>
